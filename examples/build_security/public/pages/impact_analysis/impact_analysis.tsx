...
const briefs = [
  ...
  },
  {
    title: 'Reports',
    description:
      'Overall your policy has 17% less validation rules hits and 30% less mutation rule hits. compared to your previous policy. Good job!',
  },
];
...
export const ImpactAnalysis = () => {
  ...
  return (
    <div style={{ display: 'flex' }}>
      <div>
        <EuiButton size="s" onClick={onResetData} style={{ marginRight: '10px' }}>
          Revert All Changes
        </EuiButton>
